...
public class Dish extends BaseEntity
{
    ...
    /** 菜品及套餐分类信息 */
    private List<CategoryDish> categoryDishList;
    ...
    public List<CategoryDish> getCategoryDishList()
    {
        return categoryDishList;
    }

    public void setCategoryDishList(List<CategoryDish> categoryDishList)
    {
        this.categoryDishList = categoryDishList;
    }
